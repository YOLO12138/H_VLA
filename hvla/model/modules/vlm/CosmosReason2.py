...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="/mnt/workspace/users/wanhanwen/JoyRA/examples/Robocasa_tabletop/train_files/hvla_cotrain_robocasa_gr1.yaml", help="Path to YAML config")
