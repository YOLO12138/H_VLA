...
fast_token_list=hvla/model/modules/vlm/tools/add_qwen_special_tokens/fast_tokens.txt

python hvla/model/modules/vlm/tools/add_qwen_special_tokens/add_special_tokens_to_qwen.py \
