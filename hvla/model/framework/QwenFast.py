...
from hvla.model.modules.action_model.fast_ActionHeader import get_action_model
...
if __name__ == "__main__":
    ...
    args.config_yaml = "./examples/Robotwin/train_files/hvla_cotrain_robotwin.yaml"
