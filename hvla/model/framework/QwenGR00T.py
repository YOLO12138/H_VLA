...
from hvla.model.modules.action_model.GR00T_ActionHeader import get_action_model, FlowmatchingActionHead
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./examples/Robotwin/train_files/hvla_cotrain_robotwin.yaml", help="Path to YAML config")
