...
from hvla.model.modules.vlm import get_vlm_model
from hvla.model.modules.action_model.VLA_AdapterHeader import get_action_model, VLA_Adapter_L1RegressionActionHead
from hvla.training.trainer_utils.trainer_tools import resize_images
from hvla.model.tools import FRAMEWORK_REGISTRY
from hvla.model.modules.vlm.QWen3 import IMAGE_TOKEN_INDEX, VIDEO_TOKEN_INDEX
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./hvla/config/training/hvla_train_adapter.yaml", help="Path to YAML config")
