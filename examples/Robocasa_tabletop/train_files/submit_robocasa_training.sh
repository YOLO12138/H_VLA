...
#SBATCH --output=/mnt/petrelfs/yejinhui/Projects/hvla/results/logs/%x-%j.out           # output file name
#SBATCH --error=/mnt/petrelfs/yejinhui/Projects/hvla/results/logs/%x-%j.err
...
export PYTHONPATH="$PWD/hvla/model/openvla:$PYTHONPATH"
...
export config_yaml=./examples/Robocasa_tabletop/train_files/hvla_cotrain_robocasa_gr1.yaml
