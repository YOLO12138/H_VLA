...
- **Data config (state history indices)**
  - Target path:  
    `hvla/hvla/dataloader/gr00t_lerobot/data_config.py`

- **LIBERO evaluation script (sim env returns historical states)**
  - Target path:  
    `hvla/examples/LIBERO/eval_files/eval_libero.py`
...
Purpose	Path
Dataset state history config	hvla/hvla/dataloader/gr00t_lerobot/data_config.py
LIBERO eval returns historical states	hvla/examples/LIBERO/eval_files/eval_libero.py
